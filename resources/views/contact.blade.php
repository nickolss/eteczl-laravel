...
<body>
    ...
    <main>
        <div class="card text-bg-dark text-white">
            <img src="{{URL::asset('img/etec-de-cima.jpg'); }}" class="card-img opacity-75" alt="Imagem da do auditório da Etec da Zona Leste">
            <div class="card-img-overlay d-flex flex-column justify-content-center">
                <div class="mx-5">
                    <h2 class="fs-1 fw-bolder text-light">Conheça sobre a nossa equipe</h2>
                </div>
            </div>
        </div>
        ...
        <div class="row py-5 mx-5">
            <div class="col">
                <h2 class="text-center fw-bold">Quem somos?</h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-team text-center team-style-one">
                            <div class="team-image">
                                <img src="{{URL::asset('img/noticia-image.png'); }}" alt="Team" />
                            </div>
                            <div class="team-content">
                                <h4 class="name">Jeffery Riley</h4>
                                <span class="sub-title">Função</span>
